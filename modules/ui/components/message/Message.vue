<template>
  <Transition name="fade">
    <section
      ...
      :class="
        $cn(
          'flex items-center w-full overflow-hidden min-h-[42px] max-h-[45px] px-5 rounded-xl border border-solid text-start font-medium font-inter animate-shake animate-once animate-duration-300 animate-ease-out animate-normal animate-fill-forwards',
